...
/* harmony import */ var jw_angular_pagination__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! jw-angular-pagination */ "./node_modules/jw-angular-pagination/fesm5/jw-angular-pagination.js");
...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(formBuilder, annonceService, router) {
    ...
    AddProductComponent.prototype.addProduct = function () {
        ...
        this.annonceService.addAnnonce(this.productForm.value, this.productForm.value.img).subscribe(function (response) {
...
var AnnonceClientTableComponent = /** @class */ (function () {
    function AnnonceClientTableComponent(annonceService, activatedRoute, router) {
        this.annonceService = annonceService;
    ...
    AnnonceClientTableComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        this.annonceService.getAnnonceByUser(this.id).subscribe(function (response) {
            _this.V = response.annonces;
        });
        // this.userId = localStorage.getItem("userId");
    ...
    AnnonceClientTableComponent.prototype.gotoDisplay = function (id) {
        this.router.navigate(["displayAnnonce/" + id]);
    };
    AnnonceClientTableComponent.prototype.gotoEdit = function (id) {
        this.router.navigate(["editAnnonce/" + id]);
    };
    AnnonceClientTableComponent.prototype.delete = function (id) {
        var _this = this;
        this.annonceService.deleteAnnonce(id).subscribe(function (response) {
    ...
    AnnonceClientTableComponent.ctorParameters = function () { return [
    ...
    return AnnonceClientTableComponent;
}());
...
var AnnonceTableComponent = /** @class */ (function () {
    function AnnonceTableComponent(annonceService, router) {
        this.annonceService = annonceService;
        this.router = router;
        this.V = [];
    }
    AnnonceTableComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.annonceService.getAllAnnonce().subscribe(function (response) {
            _this.V = response.annonces;
        });
    };
    AnnonceTableComponent.prototype.delete = function (id) {
        var _this = this;
        this.annonceService.deleteAnnonce(id).subscribe(function (response) {
            console.log('here delete res', response.message);
        });
    ...
    AnnonceTableComponent.prototype.gotoDisplay = function (id) {
        this.router.navigate(["displayAnnonce/" + id]);
    };
    AnnonceTableComponent.ctorParameters = function () { return [
        { type: src_app_sevices_annonce_service__WEBPACK_IMPORTED_MODULE_3__["AnnonceService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var AnnonceUserTableComponent = /** @class */ (function () {
    function AnnonceUserTableComponent(OrderService, activatedRoute) {
        this.OrderService = OrderService;
        this.activatedRoute = activatedRoute;
        this.T = [];
    }
    AnnonceUserTableComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        this.OrderService.getUserOder(this.id).subscribe(function (response) {
            console.log("here oders users ", response.myorder);
            _this.T = response.myorder;
        });
    };
    AnnonceUserTableComponent.ctorParameters = function () { return [
    ...
    return AnnonceUserTableComponent;
}());
...
var AnnonceComponent = /** @class */ (function () {
    function AnnonceComponent(router) {
        this.router = router;
    }
    AnnonceComponent.prototype.getAllAnnonce = function () {
        throw new Error('Method not implemented.');
    };
    AnnonceComponent.prototype.ngOnInit = function () {
    };
    AnnonceComponent.prototype.gotoDisplay = function (id) {
        this.router.navigate(["displayAnnonce/" + id]);
    };
    AnnonceComponent.prototype.color = function (n) {
        if (n >= 0 && n <= 50) {
            return '1';
        }
        else if (n >= 50 && n <= 300) {
    ...
    AnnonceComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var DashboardClientComponent = /** @class */ (function () {
    function DashboardClientComponent(annonceService, activatedRoute, router) {
        this.annonceService = annonceService;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.myAnnonce = [];
    ...
    DashboardClientComponent.prototype.gotoDisplay = function (id) {
        this.router.navigate(["displayAnnonce/" + id]);
    };
    DashboardClientComponent.ctorParameters = function () { return [
        { type: src_app_sevices_annonce_service__WEBPACK_IMPORTED_MODULE_3__["AnnonceService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var DisplayAnnonceComponent = /** @class */ (function () {
    function DisplayAnnonceComponent(annonceService, activatedRoute, formBuilder, orderService, router) {
        this.annonceService = annonceService;
        this.activatedRoute = activatedRoute;
        this.formBuilder = formBuilder;
        this.orderService = orderService;
        ...
        this.trackByValue = function (index, value) { return value; };
    }
    DisplayAnnonceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userId = localStorage.getItem("userId");
        console.log("here user id", this.userId);
        ...
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        this.annonceService.getAnnonceById(this.id).subscribe(function (response) {
            _this.annonce = response.annonce;
            console.log("here annonce", _this.annonce);
        });
    };
    DisplayAnnonceComponent.prototype.AddCommande = function () {
        var _this = this;
        ...
        this.orderService.addOrder(this.orderForm.value).subscribe(function (response) {
            ...
            if (response.message == "quantité insuffisante") {
                ...
                _this.qty = "il reste " + response.annonce.qty + " article";
            }
            else {
                _this.router.navigate(['']);
            }
    ...
    DisplayAnnonceComponent.ctorParameters = function () { return [
        { type: src_app_sevices_annonce_service__WEBPACK_IMPORTED_MODULE_4__["AnnonceService"] },
    ...
    return DisplayAnnonceComponent;
}());
...
var DisplayOrderComponent = /** @class */ (function () {
    function DisplayOrderComponent(orderService, activatedRoute) {
        this.orderService = orderService;
        this.activatedRoute = activatedRoute;
        this.T = [];
    }
    DisplayOrderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        this.orderService.getOrderById(this.id).subscribe(function (response) {
            console.log("here display ordder", response.comande);
            _this.T = response.comande;
        });
    };
    DisplayOrderComponent.ctorParameters = function () { return [
        { type: src_app_sevices_order_service__WEBPACK_IMPORTED_MODULE_3__["OrderService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var DisplayUserComponent = /** @class */ (function () {
    function DisplayUserComponent(userService, activatedRoute) {
    ...
    DisplayUserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        this.userService.getUserById(this.id).subscribe(function (response) {
            _this.user = response.user;
            console.log("her user", _this.user);
        });
    };
    DisplayUserComponent.ctorParameters = function () { return [
...
var EditAnnonceComponent = /** @class */ (function () {
    function EditAnnonceComponent(annonceService, activatedRoute, router, formBuilder) {
        this.annonceService = annonceService;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    EditAnnonceComponent.prototype.ngOnInit = function () {
        ...
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        this.annonceService.getAnnonceById(this.id).subscribe(function (response) {
            _this.prod = response.annonce;
        });
    };
    EditAnnonceComponent.prototype.onImageSelected = function (event) {
        var _this = this;
        var file = event.target.files[0];
        this.productForm.patchValue({ img: file });
        this.productForm.updateValueAndValidity();
    ...
    EditAnnonceComponent.prototype.editAnnonce = function () {
        var _this = this;
        this.annonceService.editAnnonceById(this.prod).subscribe(function (response) {
            console.log("here response after edit", response.message);
            alert(_this.id);
        });
        this.router.navigate(['']);
    };
    EditAnnonceComponent.ctorParameters = function () { return [
        { type: src_app_sevices_annonce_service__WEBPACK_IMPORTED_MODULE_4__["AnnonceService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
...
var EditUserComponent = /** @class */ (function () {
    function EditUserComponent(formBuilder, activatedRoute, userService, router) {
        this.formBuilder = formBuilder;
        this.activatedRoute = activatedRoute;
        this.userService = userService;
        this.router = router;
    ...
    EditUserComponent.prototype.changeStatu = function () {
        this.userService.editUserById(this.user).subscribe(function (response) {
...
var FeaturedComponent = /** @class */ (function () {
    function FeaturedComponent(annonceService) {
        this.annonceService = annonceService;
        this.T = [];
    }
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(userService, activatedRoute, router) {
        this.userService = userService;
        this.activatedRoute = activatedRoute;
        this.router = router;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.authClient = this.userService.getAuthClient().subscribe(function (isClient) {
            _this.clientIsAuthenticated = isClient;
        });
        this.UserIsAuthenticated = this.userService.getIsAuthUser();
        console.log('here auth User', this.UserIsAuthenticated);
        this.authUser = this.userService.getAuthUser().subscribe(function (isUser) {
            _this.UserIsAuthenticated = isUser;
        });
        this.adminIsAuthenticated = this.userService.getIsAuthAdmin();
        console.log('here auth Admin', this.adminIsAuthenticated);
        this.authAdmin = this.userService.getAuthAdmin().subscribe(function (isAdmin) {
    ...
    // header obj
    HeaderComponent.prototype.userObj = function () {
        var id = localStorage.getItem("userId");
        this.router.navigate(["dashboardClient/" + id]);
    };
    HeaderComponent.prototype.goToUserOrder = function () {
        var id = localStorage.getItem("userId");
...
var OrderClientComponent = /** @class */ (function () {
    function OrderClientComponent(orderService, activatedRoute) {
        this.orderService = orderService;
        this.activatedRoute = activatedRoute;
        this.T = [];
    }
    OrderClientComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.paramMap.get('id');
        console.log(this.id);
        this.orderService.getOrderByUser(this.id).subscribe(function (response) {
            _this.T = response.order;
            console.log("here order", _this.T);
        });
    };
    OrderClientComponent.prototype.delete = function (id) {
        var _this = this;
        this.orderService.deleteOrderById(id).subscribe(function (response) {
            console.log('here delete res', response.message);
        });
        this.orderService.getOrderByUser(this.id).subscribe(function (response) {
            _this.T = response.order;
    ...
    OrderClientComponent.ctorParameters = function () { return [
        { type: src_app_sevices_order_service__WEBPACK_IMPORTED_MODULE_3__["OrderService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var OrderTableComponent = /** @class */ (function () {
    function OrderTableComponent(orderService, router, activatedRoute) {
        this.orderService = orderService;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.T = [];
    ...
    OrderTableComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.activatedRoute.snapshot.paramMap.get("id");
        this.orderService.getAllOder().subscribe(function (response) {
            console.log("here response of all order ", response.comandes);
            _this.T = response.comandes;
        });
    };
    OrderTableComponent.prototype.gotoDisplay = function (id) {
...
var ShopComponent = /** @class */ (function () {
    function ShopComponent(annonceService) {
        this.annonceService = annonceService;
        this.T = [];
    }
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.signup = function () {
        ...
        this.userService.singnUp(this.signupForm.value, this.signupForm.value.img).subscribe(function (response) {
...
var UserTableComponent = /** @class */ (function () {
    function UserTableComponent(userService, router) {
        this.userService = userService;
        this.router = router;
        this.T = [];
    }
    ...
    UserTableComponent.prototype.gotoDisplay = function (id) {
        this.router.navigate(["displayUser/" + id]);
    };
    UserTableComponent.prototype.DeleteUser = function (id) {
        var _this = this;
        this.userService.deleteUserById(id).subscribe(function (response) {
    ...
    UserTableComponent.prototype.goToEdit = function (id) {
        this.router.navigate(["editUser/" + id]);
    };
    UserTableComponent.prototype.onChangePage = function (x) {
...
var CategoryPipe = /** @class */ (function () {
    ...
    CategoryPipe.prototype.transform = function (objs, term) {
        if (term === undefined) {
            return objs;
        }
...
var FilterPricePipe = /** @class */ (function () {
    ...
    FilterPricePipe.prototype.transform = function (objs, term) {
        if (term === undefined) {
            return objs;
        }
        return objs.filter(function (obj) {
...
var FilterUserPipe = /** @class */ (function () {
    function FilterUserPipe() {
    }
    FilterUserPipe.prototype.transform = function (objs, term) {
        if (term == undefined) {
            return objs;
        }
        return objs.filter(function (obj) {
...
var AnnonceService = /** @class */ (function () {
    ...
    AnnonceService.prototype.deleteAnnonce = function (id) {
        return this.httpClient.delete(this.url + "/" + id);
    };
    AnnonceService.prototype.getAnnonceByUser = function (id) {
        return this.httpClient.get(this.url + "/" + id);
    };
    AnnonceService.prototype.getAnnonceById = function (id) {
        return this.httpClient.get(this.url + "/api/" + id);
    };
    AnnonceService.prototype.editAnnonceById = function (obj) {
        return this.httpClient.put(this.url + "/" + obj._id, obj);
    };
    AnnonceService.ctorParameters = function () { return [
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.addOrder = function (obj) {
    ...
    OrderService.prototype.getAllOder = function () {
        return this.httpClient.get(this.orderURl);
    };
    OrderService.prototype.getUserOder = function (id) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.singnUp = function (user, img) {
        var formData = new FormData();
        formData.append("img", img);
    ...
    UserService.prototype.getIsAuthClient = function () {
        return this.isClient;
    };
    UserService.prototype.getIsAuthUser = function () {
        return this.isUser;
    };
    UserService.prototype.getIsAuthAdmin = function () {
        return this.isAdmin;
    };
    UserService.prototype.getAuthStatusListener = function () {
        return this.authStatusListener.asObservable();
    };
    UserService.prototype.getAuthClient = function () {
        return this.authClient.asObservable();
    };
    UserService.prototype.getAuthUser = function () {
        return this.authUser.asObservable();
    };
    UserService.prototype.getAuthAdmin = function () {
        return this.authAdmin.asObservable();
    };
    UserService.prototype.login = function (email, pwd) {
        var _this = this;
    ...
    UserService.prototype.setAuthTimer = function (duration) {
        var _this = this;
        this.tokenTimer = setTimeout(function () {
            _this.logout();
        }, duration * 1000);
    };
    UserService.prototype.saveAuthData = function (token, expirationDate, userId, userRole) {
    ...
    UserService.prototype.editUserById = function (obj) {
